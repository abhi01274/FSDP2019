...
for i in range(1880,2011):
    ls2.append(df1['Year'][(df1['Year']==i)&(df1['Sex']=="M")].count())
    ls3.append(df1['Year'][(df1['Year']==i)&(df1['Sex']=="F")].count())
...
ax1.bar(ls1[:130],ls2[:130],width=0.5, align='edge',label="Male")
ax1.bar(ls1[:130],ls3[:130],width=0.3,color= 'Red', align='center',label="FeMale")
plt.legend()
plt.show()
